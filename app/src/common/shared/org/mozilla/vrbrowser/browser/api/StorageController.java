...
public final class StorageController {
     ...
     * @return A {@link ResultAPI} that will complete when clearing has
     *         finished.
     */
    @AnyThread
    public @NonNull ResultAPI<Void> clearData(
            final @StorageControllerClearFlags long flags) {
        final BundleAPI bundle = new BundleAPI(1);
     ...
     */
    @AnyThread
    public @NonNull ResultAPI<Void> clearDataFromHost(
            final @NonNull String host,
            final @StorageControllerClearFlags long flags) {
        final BundleAPI bundle = new BundleAPI(2);
