...
/**
 * Session applications can use this class to handle media events
...
public class MediaElement {
    ...
    public static class Metadata {
        ...
        /* package */ Metadata(final Bundle bundle) {
    ...
    public static class LoadProgressInfo {
        ...
        /* package */ LoadProgressInfo(final Bundle bundle) {
    ...
    public void seek(final double time) {
        final Bundle message = createMessage();
    ...
    @UiThread
        /* package */ void notifyLoadProgress(final Bundle message) {
        if (mDelegate != null) {
    ...
    @UiThread
        /* package */ void notifyMetadataChange(final Bundle message) {
        if (mDelegate != null) {
    ...
    /* package */ MediaElement(final long videoId, final SessionAPI session) {
        mVideoId = videoId;
        mSession = session;
    }

    final protected @NonNull SessionAPI mSession;
