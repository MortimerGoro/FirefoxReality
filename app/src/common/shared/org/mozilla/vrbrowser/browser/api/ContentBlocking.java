...
public class ContentBlocking {
    ...
    public static class Settings extends RuntimeSettings {
        ...
        /* package */ final Pref<String> mSafeBrowsingPhishingTable = new Pref<>(
                ...
                "googpub-phish-proto", //BuildConfig.MOZILLA_OFFICIAL ? "goog-phish-proto" : "googpub-phish-proto",
    ...
    public static class BlockEvent {
        ...
        /* package */ static BlockEvent fromBundle(
                @NonNull final BundleAPI bundle) {
    ...
    public interface Delegate {
         ...
         */
        @UiThread
        default void onContentBlocked(@NonNull final SessionAPI session,
         ...
         */
        @UiThread
        default void onContentLoaded(@NonNull final SessionAPI session,
                                     @NonNull final BlockEvent event) {}
    }
