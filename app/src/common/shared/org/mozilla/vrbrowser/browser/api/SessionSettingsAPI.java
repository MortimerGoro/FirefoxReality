...
@AnyThread
public final class SessionSettingsAPI implements Parcelable {
    ...
    public static final class Builder {
        private final SessionSettingsAPI mSettings;
        ...
        @SuppressWarnings("checkstyle:javadocmethod")
        public Builder(final SessionSettingsAPI settings) {
            mSettings = new SessionSettingsAPI(settings);
        }
         ...
         */
        public @NonNull
        SessionSettingsAPI build() {
            return new SessionSettingsAPI(mSettings);
        }
         ...
         *             {@link SessionSettingsAPI#USER_AGENT_MODE_MOBILE SessionSettings.USER_AGENT_MODE_*} flags.
         * @return This Builder instance.
         */
         ...
         *             Use one or more of the
         *             {@link SessionSettingsAPI#DISPLAY_MODE_BROWSER SessionSettings.DISPLAY_MODE_*} flags.
         * @return This Builder instance.
         */
         ...
         *             Use one or more of the
         *             {@link SessionSettingsAPI#VIEWPORT_MODE_MOBILE SessionSettings.VIEWPORT_MODE_*} flags.
         * @return This Builder instance.
         */
    ...
    private static final String LOGTAG = "SessionSettings";
    ...
    private final SessionAPI mSession;
    private final BundleAPI mBundle;

    @SuppressWarnings("checkstyle:javadocmethod")
    public SessionSettingsAPI() {
        this(null, null);
    }

    @SuppressWarnings("checkstyle:javadocmethod")
    public SessionSettingsAPI(final @NonNull SessionSettingsAPI settings) {
        this(settings, null);
    }

    public SessionSettingsAPI(final @Nullable SessionSettingsAPI settings,
                              final @Nullable SessionAPI session) {
        mSession = session;

        if (settings != null) {
            mBundle = new BundleAPI(settings.mBundle);
            return;
        }

        mBundle = new BundleAPI();
     ...
     * @return One or more of the
     *      {@link SessionSettingsAPI#VIEWPORT_MODE SessionSettings.VIEWPORT_MODE_*} flags.
     */
     ...
     *          {@link SessionSettingsAPI#USER_AGENT_MODE}
     */
    ...
    /* package */ @NonNull BundleAPI toBundle() {
        return new BundleAPI(mBundle);
    }
    ...
    public boolean equals(final Object other) {
        return other instanceof SessionSettingsAPI &&
                mBundle.equals(((SessionSettingsAPI) other).mBundle);
    }
    ...
    public static final Parcelable.Creator<SessionSettingsAPI> CREATOR
            = new Parcelable.Creator<SessionSettingsAPI>() {
        @Override
        public SessionSettingsAPI createFromParcel(final Parcel in) {
            final SessionSettingsAPI settings = new SessionSettingsAPI();
            settings.readFromParcel(in);
            return settings;
        }

        @Override
        public SessionSettingsAPI[] newArray(final int size) {
            return new SessionSettingsAPI[size];
        }
    };
}
