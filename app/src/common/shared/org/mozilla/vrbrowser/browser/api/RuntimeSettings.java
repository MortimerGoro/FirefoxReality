...
public abstract class RuntimeSettings implements Parcelable {
    ...
    /* package */ class Pref<T> {
        ...
        public void commit() {
            final RuntimeAPI runtime = RuntimeSettings.this.getRuntime();
            if (runtime == null) {
                return;
            }
            final BundleAPI prefs = new BundleAPI(1);
            addToBundle(prefs);
        ...
        private void addToBundle(final BundleAPI bundle) {
     ...
     */
    private void forAllPrefs(final ResultAPI.Consumer<Pref<?>> visitor) {
    ...
    /* package */ void commitResetPrefs() {
        ...
        final BundleAPI data = new BundleAPI(1);
